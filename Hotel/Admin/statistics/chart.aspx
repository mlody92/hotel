<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin2.Master" AutoEventWireup="true" CodeBehind="chart.aspx.cs" Inherits="Hotel.Admin.statistics.chart" %>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="box">
                ...
                <div id="stanKontaChart" class="body in">
                    <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="stan_konta"></asp:Series>
                        </Series>
                        <ChartAreas>
            ...
            <div class="box">
                ...
                <div id="wydatkiChart" class="body collapse">
                    <asp:Chart ID="Chart14" runat="server" DataSourceID="SqlDataSource1">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="wydatki"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <div class="box">
                ...
                <div id="sumaZyskiChart" class="body collapse">
                    <asp:Chart ID="Chart15" runat="server" DataSourceID="SqlDataSource1">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="zysk"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <div class="box">
                ...
                <div id="saldoChart" class="body collapse">
                    <asp:Chart ID="Chart16" runat="server" DataSourceID="SqlDataSource1">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="saldo"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
            ...
            <div class="box">
                ...
                <div id="dzialkaChart" class="body collapse">
                    <asp:Chart ID="Chart2" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="dzialka"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <div class="box">
                ...
                <div id="pensjaChart" class="body collapse">
                    <asp:Chart ID="Chart3" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="pensja"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <div class="box">
                ...
                <div id="atrakcjeChart" class="body collapse">
                    <asp:Chart ID="Chart4" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="atrakcje"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <div class="box">
                ...
                <div id="reklamaChart" class="body collapse">
                    <asp:Chart ID="Chart5" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="reklama"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
            ...
            <div class="box">
                ...
                <div id="pokojChart" class="body collapse">
                    <asp:Chart ID="Chart6" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="pokoj"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
            ...
            <div class="box">
                ...
                <div id="kredytChart" class="body collapse">
                    <asp:Chart ID="Chart7" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="bank"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
            ...
            <div class="box">
                ...
                <div id="iloscPracChart" class="body collapse">
                    <asp:Chart ID="Chart9" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="ilosc_pracownikow"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <div class="box">
                ...
                <div id="iloscPokoiChart" class="body collapse">
                    <asp:Chart ID="Chart10" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="ilosc_pokoi"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <div class="box">
                ...
                <div id="iloscAtrChart" class="body collapse">
                    <asp:Chart ID="Chart11" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="ilosc_atrakcji"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <div class="box">
                ...
                <div id="iloscDzialekChart" class="body collapse">
                    <asp:Chart ID="Chart12" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="ilosc_dzialek"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
            ...
            <div class="box">
                ...
                <div id="iloscKredytowChart" class="body collapse">
                    <asp:Chart ID="Chart13" runat="server" DataSourceID="SqlDataSource">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="czas" YValueMembers="ilosc_kredytow"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
                        </ChartAreas>
             ...
             <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [raport] WHERE id_uzytkownika=@id_uzytkownika"></asp:SqlDataSource>  
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT (dzialka+pensja+atrakcje+reklama+pokoj+bank) as wydatki, zysk, (zysk-(dzialka+pensja+atrakcje+reklama+pokoj+bank)) as saldo, czas FROM [raport] WHERE id_uzytkownika=@id_uzytkownika"></asp:SqlDataSource> 
        </div>

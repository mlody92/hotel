<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="my.aspx.cs" Inherits="Hotel.workers.my" %>
                        ...
                        <asp:GridView GridLines="None" CellSpacing="-1" class="bordered" ID="filterHoteleGridView" runat="server" DataSourceID="filterSqlDataSource" AutoGenerateColumns="False" DataKeyNames="id" OnRowCommand="OnRowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField ShowHeader="False" ItemStyle-Width="140px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="pracownicy" Text="Pracownicy" CommandArgument='<%#Eval("dzialkaID")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>

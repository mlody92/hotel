<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="my.aspx.cs" Inherits="Hotel.hotels.my" %>
                        ...
                        <asp:GridView GridLines="None" CellSpacing="-1" class="bordered" ID="filterHoteleGridView" runat="server" DataSourceID="filterSqlDataSource" AutoGenerateColumns="False" DataKeyNames="id" OnRowCommand="OnRowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField ShowHeader="False" ItemStyle-Width="140px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="atrakcje" Text="Atrakcje" CommandArgument='<%#Eval("dzialkaID")%>' />
                                / 
                                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="pokoje" Text="Pokoje" CommandArgument='<%#Eval("dzialkaID")%>' />

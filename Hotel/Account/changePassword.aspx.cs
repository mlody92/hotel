...
namespace Hotel.Account
{
    public partial class changePassword : System.Web.UI.Page
    {
        ...
        private void changePass(String newPassword)
        {
            ...
            {
                SqlCommand xp = new SqlCommand("UPDATE uzytkownik SET password=@password WHERE id=" + Session["User_id"].ToString(), vid);
        ...
        private bool checkCurrentPassword(string password)
        {
            ...
            sql.Parameters.AddWithValue("@login", Session["User_login"].ToString());
